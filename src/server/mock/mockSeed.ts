import type { MockUser, TimesheetEntry, TimesheetWeek } from "./mock.types";
...
export const seedEntries: TimesheetEntry[] = [
  ...
  entry({
    ...
    date: "2026-01-08",
    hours: 8,
    description: "Stakeholder design review",
    projectName: "Marketing Site",
  }),
  entry({
    weekId: "w_2026_01",
  ...
  entry({
    ...
    date: "2026-01-15",
    hours: 6,
    description: "Accessibility audit follow-up",
    projectName: "Marketing Site",
  }),
  ...
  entry({
    ...
    date: "2026-01-28",
    hours: 4,
    description: "Spike: table virtualization",
    projectName: "Internal",
  }),
  // Week 5 — completed
  ...
  entry({
    ...
    date: "2026-02-10",
    hours: 12,
    description: "Timesheet filter UX overhaul",
    projectName: "Internal",
  }),
  // Week 7 — missing
  // Week 8 — incomplete
  entry({
    ...
    date: "2026-02-24",
    hours: 3.5,
    description: "Priority bug sweep",
    projectName: "Core Platform",
    workType: "Bug fixes",
  }),
  // Week 9 — completed
  ...
  entry({
    ...
    date: "2026-03-09",
    hours: 10,
    description: "Navigation shell rebuild",
    projectName: "Internal",
  }),
  entry({
    weekId: "w_2026_10",
    date: "2026-03-11",
    hours: 5,
    description: "Menu interaction polish",
    projectName: "Internal",
  }),
  // Week 11 — missing
  // Week 12 — incomplete
