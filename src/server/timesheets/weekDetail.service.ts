import { TARGET_WEEK_HOURS } from "@/lib/timesheets/timesheet.constants";
import { formatWeekDateRangeDisplay } from "@/lib/timesheets/timesheetUtils";
import type { TimesheetWeek } from "@/server/mock/mock.types";
import { getStore } from "@/server/mock/mockStore";
import type { TimesheetWeekDetailResponse } from "@/types/timesheet.types";
